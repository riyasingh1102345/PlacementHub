...
// Easy
const beginner = stackQuestions.filter(function(question){
    return question.difficulty === "Easy";
});

// Medium
const intermediate = stackQuestions.filter(function(question){
    return question.difficulty === "Medium";
});

// Hard
const advanced = stackQuestions.filter(function(question){
...
progressCount.textContent =
    `${completedQuestions.length} / ${stackQuestions.length} Questions`;
