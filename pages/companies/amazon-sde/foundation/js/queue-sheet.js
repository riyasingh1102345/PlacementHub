...
// Easy
const beginner = queueQuestions.filter(function(question){
    return question.difficulty === "Easy";
});

// Medium
const intermediate = queueQuestions.filter(function(question){
    return question.difficulty === "Medium";
});

// Hard
const advanced = queueQuestions.filter(function(question){
...
progressCount.textContent =
    `${completedQuestions.length} / ${queueQuestions.length} Questions`;
